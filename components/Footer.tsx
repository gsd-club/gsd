      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h4 className="font-semibold text-sm mb-4 text-white/80">Services</h4>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-12 pt-8 border-t border-card-border flex flex-col sm:flex-row items-center justify-between gap-4"
        >
          <p className="text-sm text-muted/50">
            &copy; 2026 GSD Club. All rights reserved.
          </p>
